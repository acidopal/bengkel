                ...
                <div class="card-body">
                   <form method="POST" action="{{ route('user.update', $id) }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="name" value="{{$user->name}}" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="email" value="{{$user->email}}"  required autofocus>
                            </div>
                        </div>
