    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                   <form method="POST" action="<?php echo e(route('user.update', $id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="name" value="<?php echo e($user->name); ?>" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="email" value="<?php echo e($user->email); ?>"  required autofocus>
                            </div>
                        </div>
