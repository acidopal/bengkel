        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php endif; ?>
                    <form  method="POST" action="<?php echo e(route('report.update', $id)); ?>">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="name_item" value="<?php echo e($transaction->name_item); ?>" required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="price" value="<?php echo e($transaction->price); ?>"  required autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="text" type="text" class="form-control" name="total_item" value="<?php echo e($transaction->total_item); ?>" required autofocus>
                            </div>
                        </div>
